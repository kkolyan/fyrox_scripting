...
| [Vector2](../LiteMath/Vector2.md) | `Abs` (  ) |  Returns a new vector with all components in absolute values (i.e. positive).    |
...
| float | `AngleTo` ( [Vector2](../LiteMath/Vector2.md) <ins>to</ins> ) |  Returns the angle to the given vector, in radians.      |
| float | `AngleToPoint` ( [Vector2](../LiteMath/Vector2.md) <ins>to</ins> ) |  Returns the angle between the line connecting the two points and the X axis, in radians.      |
| float | `Aspect` (  ) |  Returns the aspect ratio of this vector, the ratio of `X` to `Y` .    |
| [Vector2](../LiteMath/Vector2.md) | `Bounce` ( [Vector2](../LiteMath/Vector2.md) <ins>normal</ins> ) |  Returns the vector "bounced off" from a plane defined by the given normal.      |
| [Vector2](../LiteMath/Vector2.md) | `Ceil` (  ) |  Returns a new vector with all components rounded up (towards positive infinity).    |
| [Vector2](../LiteMath/Vector2.md) | `Clamp` ( [Vector2](../LiteMath/Vector2.md) <ins>min</ins>, [Vector2](../LiteMath/Vector2.md) <ins>max</ins> ) |  Returns a new vector with all components clamped between the  components of `name` and `name` using `Mathf.Clamp(real_t, real_t, real_t)` .        |
| [Vector2](../LiteMath/Vector2.md) | `Clamp` ( float <ins>min</ins>, float <ins>max</ins> ) |  Returns a new vector with all components clamped between the `name` and `name` using `Mathf.Clamp(real_t, real_t, real_t)` .        |
| float | `Cross` ( [Vector2](../LiteMath/Vector2.md) <ins>with</ins> ) |  Returns the cross product of this vector and `name` .      |
| [Vector2](../LiteMath/Vector2.md) | `CubicInterpolate` ( [Vector2](../LiteMath/Vector2.md) <ins>b</ins>, [Vector2](../LiteMath/Vector2.md) <ins>preA</ins>, [Vector2](../LiteMath/Vector2.md) <ins>postB</ins>, float <ins>weight</ins> ) |  Performs a cubic interpolation between vectors `name` , this vector, `name` , and `name` , by the given amount `name` .            |
| [Vector2](../LiteMath/Vector2.md) | `CubicInterpolateInTime` ( [Vector2](../LiteMath/Vector2.md) <ins>b</ins>, [Vector2](../LiteMath/Vector2.md) <ins>preA</ins>, [Vector2](../LiteMath/Vector2.md) <ins>postB</ins>, float <ins>weight</ins>, float <ins>t</ins>, float <ins>preAT</ins>, float <ins>postBT</ins> ) |  Performs a cubic interpolation between vectors `name` , this vector, `name` , and `name` , by the given amount `name` .  It can perform smoother interpolation than `CubicInterpolate` by the time values.                  |
| [Vector2](../LiteMath/Vector2.md) | `BezierInterpolate` ( [Vector2](../LiteMath/Vector2.md) <ins>control1</ins>, [Vector2](../LiteMath/Vector2.md) <ins>control2</ins>, [Vector2](../LiteMath/Vector2.md) <ins>end</ins>, float <ins>t</ins> ) |  Returns the point at the given `name` on a one-dimensional Bezier curve defined by this vector  and the given `name` , `name` , and `name` points.            |
| [Vector2](../LiteMath/Vector2.md) | `BezierDerivative` ( [Vector2](../LiteMath/Vector2.md) <ins>control1</ins>, [Vector2](../LiteMath/Vector2.md) <ins>control2</ins>, [Vector2](../LiteMath/Vector2.md) <ins>end</ins>, float <ins>t</ins> ) |  Returns the derivative at the given `name` on the Bezier curve defined by this vector  and the given `name` , `name` , and `name` points.            |
| [Vector2](../LiteMath/Vector2.md) | `DirectionTo` ( [Vector2](../LiteMath/Vector2.md) <ins>to</ins> ) |  Returns the normalized vector pointing from this vector to `name` .      |
| float | `DistanceSquaredTo` ( [Vector2](../LiteMath/Vector2.md) <ins>to</ins> ) |  Returns the squared distance between this vector and `name` .  This method runs faster than `DistanceTo` , so prefer it if  you need to compare vectors or need the squared distance for some formula.      |
| float | `DistanceTo` ( [Vector2](../LiteMath/Vector2.md) <ins>to</ins> ) |  Returns the distance between this vector and `name` .      |
| float | `Dot` ( [Vector2](../LiteMath/Vector2.md) <ins>with</ins> ) |  Returns the dot product of this vector and `name` .      |
| [Vector2](../LiteMath/Vector2.md) | `Floor` (  ) |  Returns a new vector with all components rounded down (towards negative infinity).    |
| [Vector2](../LiteMath/Vector2.md) | `Inverse` (  ) |  Returns the inverse of this vector. This is the same as `new Vector2(1 / v.X, 1 / v.Y)` .    |
...
| [Vector2](../LiteMath/Vector2.md) | `Lerp` ( [Vector2](../LiteMath/Vector2.md) <ins>to</ins>, float <ins>weight</ins> ) |  Returns the result of the linear interpolation between  this vector and `name` by amount `name` .        |
...
|---|---|---|---|
| `Zero` | [Vector2](../LiteMath/Vector2.md) | get |  Zero vector, a vector with all components set to `0` .  Equivalent to `new Vector2(0, 0)` .  |
| `One` | [Vector2](../LiteMath/Vector2.md) | get |  One vector, a vector with all components set to `1` .  Equivalent to `new Vector2(1, 1)` .  |
| `Inf` | [Vector2](../LiteMath/Vector2.md) | get |  Infinity vector, a vector with all components set to `Mathf.Inf` .  Equivalent to `new Vector2(Mathf.Inf, Mathf.Inf)` .  |
| `Up` | [Vector2](../LiteMath/Vector2.md) | get |  Up unit vector. Y is down in 2D, so this vector points -Y.  Equivalent to `new Vector2(0, -1)` .  |
| `Down` | [Vector2](../LiteMath/Vector2.md) | get |  Down unit vector. Y is down in 2D, so this vector points +Y.  Equivalent to `new Vector2(0, 1)` .  |
| `Right` | [Vector2](../LiteMath/Vector2.md) | get |  Right unit vector. Represents the direction of right.  Equivalent to `new Vector2(1, 0)` .  |
| `Left` | [Vector2](../LiteMath/Vector2.md) | get |  Left unit vector. Represents the direction of left.  Equivalent to `new Vector2(-1, 0)` .  |
## Static Methods
| Return Type | Signature | Description |
|---|---|---|
| [Vector2](../LiteMath/Vector2.md) | `FromAngle` ( float <ins>angle</ins> ) |  Creates a unit Vector2 rotated to the given angle. This is equivalent to doing `Vector2(Mathf.Cos(angle), Mathf.Sin(angle))` or `Vector2.Right.Rotated(angle)` .      |
## Operators
| Return Type | Signature | Description |
|---|---|---|
| [Vector2](../LiteMath/Vector2.md) | `+` ( [Vector2](../LiteMath/Vector2.md) <ins>left</ins>, [Vector2](../LiteMath/Vector2.md) <ins>right</ins> ) |  Adds each component of the `Vector2` with the components of the given `Vector2` .        |
| [Vector2](../LiteMath/Vector2.md) | `-` ( [Vector2](../LiteMath/Vector2.md) <ins>left</ins>, [Vector2](../LiteMath/Vector2.md) <ins>right</ins> ) |  Subtracts each component of the `Vector2` by the components of the given `Vector2` .        |
| [Vector2](../LiteMath/Vector2.md) | `-` ( [Vector2](../LiteMath/Vector2.md) <ins>vec</ins> ) |  Returns the negative value of the `Vector2` .  This is the same as writing `new Vector2(-v.X, -v.Y)` .  This operation flips the direction of the vector while  keeping the same magnitude.  With floats, the number zero can be either positive or negative.      |
| [Vector2](../LiteMath/Vector2.md) | `*` ( [Vector2](../LiteMath/Vector2.md) <ins>vec</ins>, float <ins>scale</ins> ) |  Multiplies each component of the `Vector2` by the given `real_t` .        |
| [Vector2](../LiteMath/Vector2.md) | `*` ( float <ins>scale</ins>, [Vector2](../LiteMath/Vector2.md) <ins>vec</ins> ) |  Multiplies each component of the `Vector2` by the given `real_t` .        |
| [Vector2](../LiteMath/Vector2.md) | `*` ( [Vector2](../LiteMath/Vector2.md) <ins>left</ins>, [Vector2](../LiteMath/Vector2.md) <ins>right</ins> ) |  Multiplies each component of the `Vector2` by the components of the given `Vector2` .        |
| [Vector2](../LiteMath/Vector2.md) | `/` ( [Vector2](../LiteMath/Vector2.md) <ins>vec</ins>, float <ins>divisor</ins> ) |  Divides each component of the `Vector2` by the given `real_t` .        |
| [Vector2](../LiteMath/Vector2.md) | `/` ( [Vector2](../LiteMath/Vector2.md) <ins>vec</ins>, [Vector2](../LiteMath/Vector2.md) <ins>divisorv</ins> ) |  Divides each component of the `Vector2` by the components of the given `Vector2` .        |
| [Vector2](../LiteMath/Vector2.md) | `%` ( [Vector2](../LiteMath/Vector2.md) <ins>vec</ins>, float <ins>divisor</ins> ) |  Gets the remainder of each component of the `Vector2` with the components of the given `real_t` .  This operation uses truncated division, which is often not desired  as it does not work well with negative numbers.  Consider using `PosMod` instead  if you want to handle negative numbers.          |
| [Vector2](../LiteMath/Vector2.md) | `%` ( [Vector2](../LiteMath/Vector2.md) <ins>vec</ins>, [Vector2](../LiteMath/Vector2.md) <ins>divisorv</ins> ) |  Gets the remainder of each component of the `Vector2` with the components of the given `Vector2` .  This operation uses truncated division, which is often not desired  as it does not work well with negative numbers.  Consider using `PosMod` instead  if you want to handle negative numbers.          |
| bool | `==` ( [Vector2](../LiteMath/Vector2.md) <ins>left</ins>, [Vector2](../LiteMath/Vector2.md) <ins>right</ins> ) |  Returns `true` if the vectors are exactly equal.  Note: Due to floating-point precision errors, consider using `IsEqualApprox` instead, which is more reliable.        |
| bool | `!=` ( [Vector2](../LiteMath/Vector2.md) <ins>left</ins>, [Vector2](../LiteMath/Vector2.md) <ins>right</ins> ) |  Returns `true` if the vectors are not equal.  Note: Due to floating-point precision errors, consider using `IsEqualApprox` instead, which is more reliable.        |
