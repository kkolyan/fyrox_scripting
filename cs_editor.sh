...
./langs/cs/FyroxLiteCs/FyroxLiteCs/install.sh $INSTALL_DIR

## NetCore library to be used in editor mode (linked to fyroxed_cs instead of fyrox_lite_cs)
./langs/cs/FyroxLiteCs/FyroxLiteCs/install_for_editor.sh $INSTALL_DIR

## NetCore executable of editor
./langs/cs/FyroxLiteCs/FyroxEdCs/install.sh $INSTALL_DIR
