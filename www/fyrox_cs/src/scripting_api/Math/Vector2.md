...
|---|---|---|---|
| `Zero` | [Vector2](../Math/Vector2.md) |  Zero vector, a vector with all components set to `0` .  Equivalent to `new Vector2(0, 0)` .  | new(0, 0) |
| `One` | [Vector2](../Math/Vector2.md) |  One vector, a vector with all components set to `1` .  Equivalent to `new Vector2(1, 1)` .  | new(1, 1) |
| `Inf` | [Vector2](../Math/Vector2.md) |  Infinity vector, a vector with all components set to `Mathf.Inf` .  Equivalent to `new Vector2(Mathf.Inf, Mathf.Inf)` .  | new(Mathf.Inf, Mathf.Inf) |
| `Up` | [Vector2](../Math/Vector2.md) |  Up unit vector. Y is down in 2D, so this vector points -Y.  Equivalent to `new Vector2(0, -1)` .  | new(0, -1) |
| `Down` | [Vector2](../Math/Vector2.md) |  Down unit vector. Y is down in 2D, so this vector points +Y.  Equivalent to `new Vector2(0, 1)` .  | new(0, 1) |
| `Right` | [Vector2](../Math/Vector2.md) |  Right unit vector. Represents the direction of right.  Equivalent to `new Vector2(1, 0)` .  | new(1, 0) |
| `Left` | [Vector2](../Math/Vector2.md) |  Left unit vector. Represents the direction of left.  Equivalent to `new Vector2(-1, 0)` .  | new(-1, 0) |
