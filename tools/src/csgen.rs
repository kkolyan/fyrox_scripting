...
pub fn main() {
    ...
    csgen_lib::lite_csgen::write_cs::write_cs(
        "langs/cs/fyrox-lite-sln/fyrox_lite_cs_netcore/src/Auto",
        facade_cs,
    );
    write_rs_to_file(
        "langs/cs/fyrox-lite-cs-lib/src/bindings_lite_2.rs",
        facade_rs,
    );
    write_rs_to_file(
        "langs/cs/fyrox-lite-cs-lib/src/internal_auto.rs",
        internal_rs,
    );
